...
export const clientFormConfig: RecordFormConfig = {
  entityLabel: "cliente",
...
export function buildClientListGroup(clients: Client[]): RecordListGroup {
  return {
...
export function getClientFormData(client: Client): RecordFormData {
  return {
    name: client.name ?? "",
...
export function buildClientPayload(formData: RecordFormData): Omit<Client, "id"> {
