...
export const serviceFormConfig: RecordFormConfig = {
  entityLabel: "servico",
...
export function buildServiceListGroup(services: PetService[]): RecordListGroup {
  return {
...
export function getServiceFormData(service: PetService): RecordFormData {
  return {
    name: service.name ?? "",
...
export function buildServicePayload(formData: RecordFormData): Omit<PetService, "id"> {
