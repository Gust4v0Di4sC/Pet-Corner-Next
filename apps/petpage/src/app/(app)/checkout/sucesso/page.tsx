...
import { CheckoutSuccessCartSync } from "@/presentation/cart-checkout/components/checkout-success-cart-sync";
...
export default async function CheckoutSuccessPage() {
  ...
  return (
    <main className="min-h-svh bg-[radial-gradient(circle_at_85%_15%,rgba(34,197,94,0.16),transparent_40%),linear-gradient(145deg,#203047_0%,#122033_55%,#0b1422_100%)]">
