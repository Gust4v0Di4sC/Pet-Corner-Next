        ...
        <div className="gridpet-content space-y-10">
          ...
          <div className="overflow-hidden" ref={emblaRef}>
            ...
            {productItems.map((product, index) => {
                ...
                const safeImage = normalizedImage || productFallback;
                const safeImageSrc =
                  typeof safeImage === "string" ? safeImage : safeImage.src;
                const isRemoteImage = /^https?:\/\//i.test(safeImageSrc);
                const isFallbackImage = safeImageSrc === productFallback.src;
