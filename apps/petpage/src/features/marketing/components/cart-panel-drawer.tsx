  ...
  const drawerPanel = (
    <div className="pointer-events-auto fixed inset-0 z-[120]">
      ...
      <aside
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="customer-cart-panel-title"
        tabIndex={-1}
        ...
        <div className="relative flex h-full flex-col">
          <header className="flex items-center justify-between border-b border-slate-300/80 bg-[#f2f2f3] px-6 py-5">
            <div className="space-y-0.5">
              <h2 id="customer-cart-panel-title" className="text-3xl font-semibold leading-none text-slate-900">Meu carrinho</h2>
          ...
          <div className="flex-1 space-y-4 overflow-y-auto px-6 py-6">
            ...
            {isLoading ? (
              ...
              <div className="rounded-2xl border border-dashed border-slate-300 bg-white/70 p-5 text-center">
                <p className="text-sm font-medium text-slate-700">Seu carrinho está vazio.</p>
