  ...
  const drawerPanel = (
    <div className="fixed inset-0 z-[120] pointer-events-auto">
      ...
      <aside
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="customer-notifications-panel-title"
        tabIndex={-1}
        ...
        <div className="relative flex h-full flex-col">
          <header className="flex items-center justify-between border-b border-slate-300/80 bg-[#f2f2f3] px-6 py-5">
            <div className="space-y-0.5">
              <h2 id="customer-notifications-panel-title" className="text-3xl font-semibold leading-none text-slate-900">Notificações</h2>
