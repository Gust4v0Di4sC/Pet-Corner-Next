  ...
  return (
    <footer id="contato" className="bg-[#1f2937] text-slate-200">
      <div className="gridpet">
        <div className="gridpet-content grid gap-12 py-14 md:grid-cols-[1.1fr_1fr_1fr]">
      ...
      <div className="border-t border-slate-600 py-5">
        <div className="gridpet">
          <div className="gridpet-content flex flex-wrap items-center justify-between gap-3 text-xs text-slate-400">
