...
import { updateCustomerProfileImage } from "@/features/account/services/firebase-customer.adapter";
import { getFirebaseAuth, waitForFirebaseUser } from "@/lib/auth/firebase-auth.adapter";
import { createCustomerNotification } from "@/features/notifications/services/customer-notification.service";
